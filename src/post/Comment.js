            ...
            <div>
                ...
                <form onSubmit={this.addComment}>
                    <div className="form-group">
                        ...
                        />
                        <button className="btn btn-raised btn-success mt-2 rnd">
                            Comment <i class="fa fa-paper-plane" aria-hidden="true"></i>
                        </button>
                    </div>
                </form>
                ...
                <div className="col-md-12">
                    <h3 className="text-primary"><i class="fa fa-comment" aria-hidden="true"></i>  {comments.length}</h3>
                    <hr />
